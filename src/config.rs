...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("秋末云".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rt.qiu.ink"];
pub const RS_PUB_KEY: &str = "n+xcPKcfRFJ7qwP6KtT5bK8xU7TFslx4+fzSdmM+p1U=";
